...
export const metadata: Metadata = {
  title: "About",
  description: `Independent print shop in south east London since ${site.foundedYear}. Business stationery, marketing and large-format print, with a ${site.turnaround} standard turnaround from our premises in ${site.address.addressLocality}.`,
...
const capabilities = [
  {
    ...
    description:
      "Business cards, flyers, multi-page brochures, presentation folders and full starter packs. Printed on 80gsm-400gsm or recycled stock, finished matte, gloss, or silk.",
    image: "/bcards.webp",
  },
  {
    title: "Large Format",
    description:
      "Prints from A3 up to 1500mm width on a continuous roll, plus site boards and Heras fencing banners. Weatherproof Foamex, and artwork tiled to read as one design across a whole run.",
    image: "/poster.webp",
  },
  {
  ...
  return (
    <>
      <section className="c-blue px-4 pt-10 pb-24 sm:px-6 sm:pb-28">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-[3fr_2fr] md:items-center md:gap-8">
          ...
          <div className="grid grid-cols-3 gap-3 md:grid-cols-1 md:gap-4">
            <div className="flex flex-col items-center justify-center rounded-2xl border border-white/15 bg-white/10 px-3 py-5 text-center backdrop-blur-sm sm:px-6 sm:py-6">
            ...
            <a
              href="#reviews"
              className="flex flex-col items-center justify-center rounded-2xl bg-surface-2 px-3 py-5 text-center shadow-card transition-all hover:-translate-y-0.5 hover:shadow-card-hover sm:px-6 sm:py-6"
            >
            ...
            <div className="c-teal flex flex-col items-center justify-center rounded-2xl px-3 py-5 text-center shadow-card sm:px-6 sm:py-6">
              <p className="font-display text-2xl font-bold whitespace-nowrap text-white sm:text-3xl">
                24-48h
              </p>
              <p className="ts mt-1 text-[11px] font-semibold tracking-wide uppercase">
                Standard Turnaround
      ...
      <div className="relative -mt-14 px-4 sm:-mt-16 sm:px-6">
        <div className="mx-auto max-w-4xl rounded-3xl bg-surface-2 p-6 shadow-card sm:p-8">
